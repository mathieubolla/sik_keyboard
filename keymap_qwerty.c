...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  KEYMAP(
      KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,    KC_P7,    KC_P8,    KC_P9,  KC_TRNS,  KC_TRNS,  KC_TRNS,     KC_6,    KC_NO,    KC_NO,
      ...
      KC_7,     KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,    KC_P0,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_FN4,   KC_FN3,  KC_TRNS,  KC_TRNS),
  KEYMAP(
      ...
      KC_MINS,     KC_T,     KC_A,      KC_E,  KC_TRNS,  KC_TRNS,  KC_TRNS,     KC_S,     KC_I,     KC_N,  KC_QUOT,  KC_LALT,   KC_TAB,
       ...
       KC_DOT,   KC_FN2,     KC_Y,      KC_J,  KC_TRNS,  KC_TRNS,  KC_TRNS,     KC_X,     KC_Z,     KC_K,     KC_3,  KC_LGUI,  KC_LSFT),
  KEYMAP(
      ...
      KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,  KC_TRNS,    KC_P0,  KC_TRNS,  KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_FN3,  KC_TRNS,  KC_TRNS),
  KEYMAP(
      ...
      KC_TRNS,  KC_TRNS,  KC_TRNS,   KC_TRNS,   KC_F10,   KC_F11,   KC_F12,  KC_TRNS,  KC_TRNS,   KC_FN4,  KC_TRNS,  KC_TRNS,  KC_TRNS),
};
